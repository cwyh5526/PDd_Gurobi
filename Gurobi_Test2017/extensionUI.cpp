...
void drawAnimation() {
	...
	if (animationTime < 0) {
		...
		sAnimationTet = staticTet;
		rAnimationTet = restTet;

		for (int i = 0; i < 4; ++i) {
			sGrad[i].x = sOptimalTet.vertex[i].x - staticTet.vertex[i].x;
			sGrad[i].y = sOptimalTet.vertex[i].y - staticTet.vertex[i].y;
			sGrad[i].z = sOptimalTet.vertex[i].z - staticTet.vertex[i].z;


			rGrad[i].x = rOptimalTet.vertex[i].x - restTet.vertex[i].x;
			rGrad[i].y = rOptimalTet.vertex[i].y - restTet.vertex[i].y;
			rGrad[i].z = rOptimalTet.vertex[i].z - restTet.vertex[i].z;


			sGrad[i].x = sGrad[i].x / timestep;
			sGrad[i].y = sGrad[i].y / timestep;
			sGrad[i].z = sGrad[i].z / timestep;
									  
			rGrad[i].x = rGrad[i].x / timestep;
			rGrad[i].y = rGrad[i].y / timestep;
			rGrad[i].z = rGrad[i].z / timestep;
	...
	else if (animationTime == (int) timestep + timeGap) {
	...
	else
	{
		for (int i = 0; i < 4; ++i) {
			...
			sAnimationTet.vertex[i].x += sGrad[i].x;
			sAnimationTet.vertex[i].y += sGrad[i].y;
			sAnimationTet.vertex[i].z += sGrad[i].z;

			rAnimationTet.vertex[i].x += rGrad[i].x;
			rAnimationTet.vertex[i].y += rGrad[i].y;
			rAnimationTet.vertex[i].z += rGrad[i].z;
