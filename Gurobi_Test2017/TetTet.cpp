...
//	std::vector<vec3> P_V1(4);
//	for (std::size_t i = 0; i < 4; ++i)
//		P_V1[i] = V2[i] - V1[0];
//
//	// Data structure for edges of V1 and V2
//	std::vector<vec3> e_v1(5), e_v2(5);
//	e_v1[0] = V1[1] - V1[0];
//	e_v1[1] = V1[2] - V1[0];
//	e_v1[2] = V1[3] - V1[0];
//	vec3 n = e_v1[1].cross(e_v1[0]);
//
...
////-----------------------------------------------------------------------------
//bool
//CollisionDetection::collides_edge_edge(const vec3& a,
//	const vec3& b,
//	const vec3& c,
//	const vec3& d)
//{
...
//}
////-----------------------------------------------------------------------------
//bool CollisionDetection::collides_interval_point(const vec3& p0,
//	const vec3& p1,
//	const vec3& point)
//{
...
//
////-----------------------------------------------------------------------------
//bool CollisionDetection::collides_triangle_point_2d(const vec3& p0,
//	const vec3& p1,
//	const vec3& p2,
//	const vec3 &point)
//{
...
//}
////-----------------------------------------------------------------------------
//bool CollisionDetection::collides_triangle_point(const vec3& p0,
//	const vec3& p1,
//	const vec3& p2,
//	const vec3 &point)
//{
...
////-----------------------------------------------------------------------------
//bool
//CollisionDetection::collides_triangle_triangle(const vec3& p0,
//	const vec3& p1,
//	const vec3& p2,
//	const vec3& q0,
//	const vec3& q1,
...
//
//	const vec3 Vmid = (p0 + p1 + p2) / 3.;
//	const vec3 Umid = (q0 + q1 + q2) / 3.;
...
////-----------------------------------------------------------------------------
//bool
//CollisionDetection::collides_tetrahedron_point(const vec3& p0,
//	const vec3& p1,
//	const vec3& p2,
//	const vec3& p3,
//	const vec3& point)
...
//		const vec3 v1 = *p[(i + 1) % 4] - *p[i];
//		const vec3 v2 = *p[(i + 2) % 4] - *p[i];
//		const vec3 v3 = *p[(i + 3) % 4] - *p[i];
//		const vec3 v = point - *p[i];
...
////-----------------------------------------------------------------------------
//bool
//CollisionDetection::collides_tetrahedron_triangle(const vec3& p0,
//	const vec3& p1,
//	const vec3& p2,
//	const vec3& p3,
//	const vec3& q0,
...
//}
////-----------------------------------------------------------------------------
//bool CollisionDetection::coplanar_tri_tri(const vec3& N,
//	const vec3& V0,
//	const vec3& V1,
//	const vec3& V2,
//	const vec3& U0,
...
////-----------------------------------------------------------------------------
//bool
//CollisionDetection::separating_plane_face_A_1(const std::vector<vec3>& pv1,
//	const vec3& n,
...
////-----------------------------------------------------------------------------
//bool
//CollisionDetection::separating_plane_face_A_2(const std::vector<vec3>& V1,
